...
class InputBox(GuiObject):
    ...
    def __init__(self,unit,label="",text="",dirty=1):
        ...
        self.font = pygame.font.Font(data.filepath("font", "abel.ttf"), int(self.unit * 2))
        self.text = text

        self.label = Label(self.unit,"Digit your name and press ENTER",int(self.unit*1.3),(255,255,255),dirty=2)
